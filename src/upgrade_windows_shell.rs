pub const WINDOWS_UPGRADE: &str = concat!(
	...
	"$source2 += \"{`n\"\n",
	"$source2 += \"    private const string errorString = `\"{{{UpgradeShellException}}}`\";`n\"\n",
	...
	"$source2 += \"        {`n\"\n",
	"$source2 += \"            Console.WriteLine(`\"CreatePseudoConsole function found! Spawning a fully interactive shell`\");`n\"\n",
	"$source2 += \"`n\"\n",
	...
	"$source2 += \"        output += `\"UpgradeShell kindly exited.`\";`n\"\n",
	"$source2 += \"        return output;`n\"\n",
	"$source2 += \"    }`n\"\n",
	"$source2 += \"}`n\"\n",
	"$source2 += \"`n\"\n",
	...
	"$source2 += \"            throw new UpgradeShellException(`\"UpgradeShell: Invalid integer value `\" + arg);`n\"\n",
	...
	"$source2 += \"        {`n\"\n",
	"$source2 += \"            Console.WriteLine(e.ToString());`n\"\n",
	"$source2 += \"        }`n\"\n",
	"$source2 += \"`n\"\n",
	"$source2 += \"        return output;`n\"\n",
	"$source2 += \"    }`n\"\n",
